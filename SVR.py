...
raw_data = pd.read_csv(r'C:\Users\a\Desktop\SVR-GMMs-Kanto\SVR_GMMs_D90\D90\DataD902.csv',encoding='GBK')
...
writer_xunlian=pd.ExcelWriter(r'C:\Users\a\Desktop\SVR-GMMs-Kanto\SVR_GMMs_D90\D90\train.xls')
...
writer_ceshi=pd.ExcelWriter(r'C:\Users\a\Desktop\SVR-GMMs-Kanto\SVR_GMMs_D90\D90\test.xls')
...
model_svr = SVR(kernel="rbf",gamma=0.279,C=4.177,epsilon=0.045) # Set the hyperparameters of SVR GMMs
model_names = ['SVR']
model_dic = [model_svr]
cv_score_list = []
pre_y_list = []
...
new_pre_SVR_y = []
raw_data = pd.read_csv(r'C:\Users\a\Desktop\SVR-GMMs-Kanto\SVR_GMMs_D90\D90\shujv2222-11.csv',encoding='GBK') # input the information for prediction (R,M,Vs30)
